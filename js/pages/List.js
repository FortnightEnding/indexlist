...
export default {
        ...
        <main v-else class="page-list">
            <div class="list-container">
                ...
                <div v-else style="padding: 16px;">
                    <p class="type-label-lg">No levels loaded.</p>
                </div>
            </div>
            ...
            <div class="level-container">
                <div class="level" v-if="level">
                    ...
                    <table class="records">
                        <tbody>
                            <tr
                                v-for="(record, idx) in (level.records || [])"
                                :key="idx"
                                class="record"
                            >
                                <td class="percent">
            ...
            <div class="meta-container">
                <div class="meta">
                    <div class="errors" v-show="errors.length > 0">
                        <p class="error" v-for="(error, idx) of errors" :key="idx">{{ error }}</p>
                    </div>
    ...
    computed: {
        level() {
            ...
            const row = this.list[this.selected];
        ...
        video() {
            ...
            // If toggledShowcase isn't defined elsewhere, this will just be falsey and use verification.
            return embed(
    ...
    async mounted() {
        ...
        if (!this.list) {
            ...
            // Keep selected in bounds if list is shorter than expected
            if (this.selected < 0) this.selected = 0;
            if (this.list.length && this.selected >= this.list.length) this.selected = 0;
        }
